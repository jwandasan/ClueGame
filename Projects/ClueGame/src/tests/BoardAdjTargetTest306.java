...
public class BoardAdjTargetTest306 {
	...
	public void testTargetsInDiningRoom() {
		// test a roll of 1
		board.calcTargetExecute(board.getCell(12, 20), 1);
		...
		// test a roll of 3
		board.calcTargetExecute(board.getCell(12, 20), 3);
		...
		// test a roll of 4
		board.calcTargetExecute(board.getCell(12, 20), 4);
		targets= board.getTargets();
	...
	public void testTargetsInKitchen() {
		// test a roll of 1
		board.calcTargetExecute(board.getCell(20, 19), 1);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(2, targets.size());
		...
		// test a roll of 3
		board.calcTargetExecute(board.getCell(20, 19), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargetExecute(board.getCell(20, 19), 4);
		targets= board.getTargets();
		assertEquals(9, targets.size());
	...
	public void testTargetsAtDoor() {
		...
		board.calcTargetExecute(board.getCell(8, 17), 1);
		Set<BoardCell> targets= board.getTargets();
		...
		// test a roll of 3
		board.calcTargetExecute(board.getCell(8, 17), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargetExecute(board.getCell(8, 17), 4);
		targets= board.getTargets();
	...
	public void testTargetsInWalkway1() {
		// test a roll of 1
		board.calcTargetExecute(board.getCell(11, 2), 1);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(2, targets.size());
		...
		// test a roll of 3
		board.calcTargetExecute(board.getCell(11, 2), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargetExecute(board.getCell(11, 2), 4);
		targets= board.getTargets();
		assertEquals(3, targets.size());
		assertTrue(targets.contains(board.getCell(14, 2)));
		assertTrue(targets.contains(board.getCell(8, 2)));
	...
	public void testTargetsInWalkway2() {
		// test a roll of 1
		board.calcTargetExecute(board.getCell(13, 7), 1);
		Set<BoardCell> targets= board.getTargets();
		assertEquals(4, targets.size());
		...
		// test a roll of 3
		board.calcTargetExecute(board.getCell(13, 7), 3);
		targets= board.getTargets();
		...
		// test a roll of 4
		board.calcTargetExecute(board.getCell(13, 7), 4);
		targets= board.getTargets();
		assertEquals(15, targets.size());
		assertTrue(targets.contains(board.getCell(14, 2)));
	...
	public void testTargetsOccupied() {
		...
		board.getCell(15, 7).setIsOccupied(true);
		board.calcTargetExecute(board.getCell(13, 7), 4);
		board.getCell(15, 7).setIsOccupied(false);
		Set<BoardCell> targets = board.getTargets();
		...
		board.getCell(12, 20).setIsOccupied(true);
		board.getCell(8, 18).setIsOccupied(true);
		board.calcTargetExecute(board.getCell(8, 17), 1);
		board.getCell(12, 20).setIsOccupied(false);
		board.getCell(8, 18).setIsOccupied(false);
		targets= board.getTargets();
		assertEquals(3, targets.size());
		assertTrue(targets.contains(board.getCell(7, 17)));	
		...
		board.getCell(12, 15).setIsOccupied(true);
		board.calcTargetExecute(board.getCell(12, 20), 3);
		board.getCell(12, 15).setIsOccupied(false);
		targets= board.getTargets();
